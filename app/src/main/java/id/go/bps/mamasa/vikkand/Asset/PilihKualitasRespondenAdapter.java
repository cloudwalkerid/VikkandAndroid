...
public class PilihKualitasRespondenAdapter extends RecyclerView.Adapter<PilihKualitasRespondenAdapter.ViewHolder> implements Filterable {
    ...
    public PilihKualitasRespondenAdapter(Activity myActivity, ObjectSurvei objectSurvei){
        this.myActivity = myActivity;
        this.objectSurvei = objectSurvei;
        //Toast.makeText(myActivity, "Dapat ", Toast.LENGTH_SHORT).show();
        objectKualitas = Database.getInstance(myActivity).getKualitasSurvei(objectSurvei.getUid_survei());
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kualitas_responden, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(item.getTipe().equals("1")){
            holder.jenis.setText("Toko Bangunan");
        }else if(item.getTipe().equals("2")){
            holder.jenis.setText("Bahan Material");
        }else if(item.getTipe().equals("3")){
            holder.jenis.setText("Kayu/Kuseng");
        }else if(item.getTipe().equals("4")){
            holder.jenis.setText("Kaca");
        }else if(item.getTipe().equals("5")){
            holder.jenis.setText("Alat Berat");
        }else if(item.getTipe().equals("6")){
            holder.jenis.setText("Alumunium");
        }else if(item.getTipe().equals("7")){
            holder.jenis.setText("Upah Jasa");
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener, View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            jenis = (TextView) itemView.findViewById(R.id.item_kualitas_jenis);
    ...
    public void setStatus(ObjectKualitas item, ObjectKualitas baru){
        ...
        if(!item.getTipe().equals("5") && !item.getTipe().equals("7")){
            ...
            if(!((ObjectKualitasTipe2) item).getSatuan_unit().equals("000-000")){
                if(((ObjectKualitasTipe2) baru).getSatuan_unit().trim().equals("")){
                    baru.setStatus("1");
                }
            }else{
            ...
            if(!((ObjectKualitasTipe2) item).getNilai_sewa().equals("000-000")){
                if(((ObjectKualitasTipe2) baru).getNilai_sewa().trim().equals("")){
                    baru.setStatus("1");
                }
            }else {
    ...
    private class KualitasFilter extends Filter{
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            objectKualitasLocal = Database.getInstance(myActivity).getKualitasSurveiFilter(objectSurvei.getUid_survei()
